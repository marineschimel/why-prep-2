...
let betas = [| 10.; 100.; 500.; 900.; 1000.; 10000.; 100000.; 1000000. |]
let _ = [| 100.; 1000.; 2000.; 5000.; 10000.; 100000.; 1000000. |]
...
let accuracy_theta x =
  ...
  let fp = let m = Mat.get_slice [ [ -200 ]; [ 0; 1 ] ] x in
  Mat.mean ~axis:0 m in 
  Mat.(fp - tp) |> Mat.l2norm_sqr'


(*Add functions for computing max hand speed/input energy etc*)
